    ...
    def _extract_EditionData(self, res, RegFile3=False, data3={}, RegFile4=False, data4={}):
        ...
        if RegFile4:
            evals.update({
                ...
                'gross_quantity'   : int(data4.find('prints_gross') and data4.find('prints_gross').text or 0),
                'net_quantity'     : int(data4.find('prints_net') and data4.find('prints_net').text or 0),

                'waste_start' : int(data4.find('waste_start') and data4.find('waste_start').text or 0),
                'waste_total' : int(data4.find('waste_total')and data4.find('waste_total').text or 0),

                'paper_mass_1'  : int(data4.find('used_gram01') and data4.find('used_gram01').text or 0),
                'paper_mass_2'  : int(data4.find('used_gram02') and data4.find('used_gram02').text or 0),
                'paper_mass_3'  : int(data4.find('used_gram03') and data4.find('used_gram03').text or 0),
                'paper_mass_4'  : int(data4.find('used_gram04') and data4.find('used_gram04').text or 0),
                'paper_mass_5'  : int(data4.find('used_gram05') and data4.find('used_gram05').text or 0),
                'paper_mass_6'  : int(data4.find('used_gram06') and data4.find('used_gram06').text or 0),
                'paper_mass_7'  : int(data4.find('used_gram07') and data4.find('used_gram07').text or 0),

                'paper_width_1'  : int(data4.find('used_webwidth01') and data4.find('used_webwidth01').text or 0),
                'paper_width_2'  : int(data4.find('used_webwidth02') and data4.find('used_webwidth02').text or 0),
                'paper_width_3'  : int(data4.find('used_webwidth03') and data4.find('used_webwidth03').text or 0),
                'paper_width_4'  : int(data4.find('used_webwidth04') and data4.find('used_webwidth04').text or 0),
                'paper_width_5'  : int(data4.find('used_webwidth05') and data4.find('used_webwidth05').text or 0),
                'paper_width_6'  : int(data4.find('used_webwidth06') and data4.find('used_webwidth06').text or 0),
                'paper_width_7'  : int(data4.find('used_webwidth07') and data4.find('used_webwidth07').text or 0),
               })
